...
export const api = {
  ...
  cliJob: (id: string) => request<CliJob>("GET", `/api/clis/jobs/${id}`),
  cliAnswer: (id: string, text: string) => request<CliJob>("POST", `/api/clis/jobs/${id}/input`, { text }),
  cliCancel: (id: string) => request<CliJob>("POST", `/api/clis/jobs/${id}/cancel`),
